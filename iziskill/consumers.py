...
from .models import Room, Messager, User  # Assurez-vous que ces modèles sont importés correctement
...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    def save_message(self, message, username, room_name):
        ...
        Messager.objects.create(user=user,room=room,content=message)
